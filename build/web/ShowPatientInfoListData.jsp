<%-- 
    Document   : ShowPatientInfoListData
    Created on : Sep 24, 2017, 8:39:34 AM
    Author     : User
--%>
                    ...
                    <div class="panel panel-default di">
                        ...
                        <div class="panel-body si">
                            <table class="table table-hover">
                                ...
                                %>
                                <tr  onclick="window.document.location = 'ServeletShowGraph?idMea=<%=d.getMeasureId()%>&idPat=<%=p.getPatId()%>';">
