...
/* public static void sendDataPatient(String fname, String lname, String birdthdate, String address, String subDistrict,
            String district, String province, String patTel, String bloodType, String docId, String underlyingDisease) 

StringEntity params
                = new StringEntity(("{\"patFirstName\":\""+fname+"\","
                        + "\"patLastName\":\""+lname+"\","
                        + "\"birthDay\":\""+birdthdate+"\","
                        + "\"address\":\""+address+"\","
