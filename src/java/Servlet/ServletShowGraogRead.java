 ...
 * @author User
 */
@WebServlet(name = "ServletShowGraogRead", urlPatterns = {"/ShowGraogRead"})
public class ServletShowGraogRead extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("idMea"+idMea);
        ...
        getServletContext().getRequestDispatcher("/ShowGraphRead.jsp").forward(request, response);
    }
