 ...
 * @author User
 */
 @WebServlet(name = "jko", urlPatterns = {"/jko"})
public class jko extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       /* String fname = request.getParameter("fname");
        ...
        String tel = request.getParameter("patTel");
        String blood = request.getParameter("bloodType");
        String docId = request.getParameter("docterId");
        String underlyingDisease = request.getParameter("underlyingDisease");*/
